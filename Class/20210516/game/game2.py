...
def buy_inshop(stat: list):
    ...
    while True:
        ...
        if item == 'm':
            ...
            t.sleep(0.75)
            print('One costs 500 $RpgD. Press \'m\' to buy.')
            t.sleep(0.75)
            ...
            t.sleep(0.75)
            print('One costs 500 $RpgD. Press \'p\' to buy.')
            t.sleep(0.75)
            ...
            if gadget == 'm':
                ...
                while True:
                    t.sleep(0.75)
                    confirm = input('Confirm purchase?\n(Press \'m\' to confirm your HPpurchase.)\n')
                ...
                while True:
                    t.sleep(0.75)
                    confirm = input('Confirm purchase?\n(Press \'p\' again to confirm your HPpurchase.)\n')
